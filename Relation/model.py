...
class Att_BLSTM(nn.Module):
    def __init__(self, word_vec, class_num, max_len, word_dim, hidden_size, layers_num, emb_dropout, lstm_dropout, linear_dropout):
        super().__init__()
        ...
        self.emb_dropout_value = emb_dropout
        self.lstm_dropout_value = lstm_dropout
        self.linear_dropout_value = linear_dropout
